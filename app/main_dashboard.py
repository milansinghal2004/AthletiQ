...
from app.services import analysis_engine, llm_engine
...
def sync_and_compare(practice_video, shot_type, progress=gr.Progress()):
    ...
    # Generate unified feedback with LLM
    print("\033[94m[Analysis] Generating premium biomechanical report...\033[0m")
    out_video, styled_feedback = analysis_engine.generate_biomechanical_report(
        practice_video, ref_video, practice_data, stats_data, 
        shot_type, p_phases, r_phases, alignment_path
    )
    ...
    return out_video, styled_feedback, plots
    ...
    with gr.Tab("Performance Dashboard"):
        with gr.Row():
            ...
            with gr.Column(scale=1):
                ...
                out_score     = gr.HTML("Score will appear here.")
