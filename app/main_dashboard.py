...
def process_video_for_seg(video_path):
    ...
    while True:
        ...
        idx += 1
    cap.release()
    return first_frame, first_frame, playable_path
...
with gr.Blocks() as demo:
    ...
    with gr.Tab("Performance Dashboard"):
        ...
        video_input.upload(process_video_for_seg, video_input, [first_frame_display, clean_img_state, playable_video_state])
        ...
        analyze_btn.click(segment_player, inputs=[playable_video_state, click_coord_state, shot_select], outputs=[out_isolated, out_json, out_comparison, out_score])
